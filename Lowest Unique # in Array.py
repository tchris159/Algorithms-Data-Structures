...
#
# Output:
# Print the winner's position in the input list, or 0 if there is no winner (there are no unique numbers). In the first sample test case, the lowest unique number is 6. So player 5 wins.
#
# Test 1
# Test Input Download Test Input3 3 9 1 6 5 8 1 5 3
# Expected Output Download Test Output5
# Test 2
# Test Input Download Test Input9 2 9 9 1 8 8 8 2 1 1
# Expected Output Download Test Output0
